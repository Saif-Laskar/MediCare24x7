    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(blank=True, choices=[('Cardiology', 'Cardiology'), ('Dentistry', 'Dentistry'), ('Dermatology', 'Dermatology'), ('Endocrinology', 'Endocrinology'), ('Gastroenterology', 'Gastroenterology'), ('General Surgery', 'General Surgery')], max_length=20, null=True)),
